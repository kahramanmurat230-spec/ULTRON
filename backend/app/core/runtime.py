...
class UltronRuntime:
    ...
    def _register_tools(self):
        ...
        reg.register('email_search',lambda query,limit=10: self._email.search(query,limit=limit),'E-posta konu araması yapar (IMAP SEARCH).',{'type':'object','properties':{'query':{'type':'string'}},'required':['query']})
